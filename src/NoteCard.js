    ...
    return (
      <div className="card bg-light mb-3">
        <div className="card-header">
          ...
          <a href="#">
            <svg onClick={() => this.props.onArchiveNote(note.id)} className="bi bi-x-square" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
